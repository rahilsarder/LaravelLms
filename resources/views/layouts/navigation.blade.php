<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                          <a class="dropdown-item" href="{{ route('advising') }}">Advising</a>
                          <a class="dropdown-item" href="#">Advising Slip</a>
                          <a class="dropdown-item" href="{{ route('advising.show', 1) }}">Advised Courses</a>
                        </div>
                    </div>
                    {{-- <x-nav-link :href="route('advising')" :active="request()->routeIs('advising')">
                        {{ __('Advising') }}
                    </x-nav-link> --}}
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="url('/course')" :active="request()->routeIs('dashboard')">
                {{ __('Courses') }}
            </x-responsive-nav-link>
        </div>
